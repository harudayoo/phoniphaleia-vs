...
class ElectionReviewController:
    @staticmethod
    def get_all():
        try:
            ...
            for e in elections:
                ...
                results_updated = ElectionReviewController._check_and_update_election_with_results(e)
                if results_updated:
    ...
    def update(election_id):
        try:
            ...
            # Check if election has results first - this takes precedence
            results_updated = ElectionReviewController._check_and_update_election_with_results(election)
            ...
            return jsonify({
                ...
                'date_start': election.date_start.isoformat(), 
                'date_end': election.date_end.isoformat(), 
                'queued_access': election.queued_access, 
                'max_concurrent_voters': election.max_concurrent_voters
            }), 200
        except Exception as ex:
