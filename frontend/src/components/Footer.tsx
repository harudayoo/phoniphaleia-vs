...
export default function Footer() {
  return (
    <footer className="bg-red-800 text-white p-1">
        ...
        <div className="flex flex-col items-center justify-center">
          <div className="flex space-x-4 mb-2">
            ...
            <a
              ...
              className="w-6 h-6 border border-white rounded flex items-center justify-center hover:bg-white hover:text-red-800 transition-colors duration-200"
              aria-label="Facebook"
            >
              <svg
